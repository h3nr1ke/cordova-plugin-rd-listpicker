...
- (void)showPicker:(CDVInvokedUrlCommand*)command {
    ...
    [self.commandDelegate runInBackground:^{
        ...
        NSString *alignment = [options objectForKey:@"alignment"] ?: @"1";
        ...
        for (int i = 0; i < self.items.count; i++) {
            ...
            if (icon != nil) {
                ...
                NSString* shortFileName = [[icon stringByAppendingString:@"@3x"] stringByAppendingPathExtension: @"png"];
                ...
                if ([fileManager fileExistsAtPath:urlPath.path]) {
                    ...
                    UIImage *iconImage = [[UIImage alloc] initWithData:data scale:3];
